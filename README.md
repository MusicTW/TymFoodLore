...
TymFoodLore is a Minecraft Paper plugin for food lore and item lore. It displays vanilla and ItemsAdder food stats, supports Paper 1.21.x servers, and can connect ItemsAdder food items to Codex discovery unlocks.

Keywords: Minecraft plugin, Paper plugin, Spigot plugin, Bukkit plugin, Minecraft server plugin, food lore, item lore, ItemsAdder, ItemsAdder food, Codex discoveries, LuckPerms, Java 21, Paper 1.21.
